...
num_split = 10
raw_dataset_dir = './datasets/UCSD_dataset'
main_mdl_dir = os.path.join('CSGNet','UCSD', f'models{num_split}')
results_dir = os.path.join('CSGNet','UCSD', f'results{num_split}')
...
for scene in dataset:
    ...
    ROI_file = os.path.join(raw_dataset_dir, scene, 'ROI.bmp')
    ...
    scene_input_path = os.path.join(raw_dataset_dir, scene, 'in')
